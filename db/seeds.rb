...
task1 = Task.create!(name: 'MyTask1', description: 'descr', status: 'unfinished', project: project1, assignee: user1)
task2 = Task.create!(name: 'MyTask2', description: 'descr', status: 'unfinished', project: project2, assignee: user2)
task3 = Task.create!(name: 'MyTask3', description: 'descr', status: 'unfinished', project: project3, assignee: user3)
task4 = Task.create!(name: 'MyTask4', description: 'descr', status: 'unfinished', project: project4, assignee: user4)
